...
"ignore_report": {
  ...
  options: [
    ...
    { id: "replyAgain", text: "Responder para esclarecer", next: "endIgnore2", points: 0, feedback: "Responder a um número falso expôs você a mais riscos." }
      ...
      "verify2": {
        ...
        options: [
          ...
          { id: "shareCode", text: "Pesquisar sobre o a mensagem", next: "endInformation", points: 2, feedback: "Nunca compartilhe códigos de verificação, pois eles dão acesso total à sua conta." },
      ...
      "endVerifyDelete": {
        text: "Ignorar as mensagens pareceu resolver, mas os golpistas clonaram sua conta usando respostas anteriores. Seus contatos recebem mensagens falsas. Sempre confirme identidades! Recupere sua conta em https://faq.whatsapp.com/.",
        image: "/assets/images/bad_end.jpg",
        options: []
      },
      "endVerifyIgnore": {
      ...
      "endVerifyMonitor": {
        text: "Você verifica as sessões ativas e nota um dispositivo estranho, mas sem medidas adicionais, sua conta permanece vulnerável. Ative a verificação em duas etapas e desconecte dispositivos suspeitos nas configurações.",
        image: "/assets/images/medium_end.jpg",
        options: []
      },
      "endVerifySoftUpdate": {
    ...
    const instagramStoryParts = {
      "start": {
        text: "Você vê um Story no Instagram de uma 'Nike Oficial' prometendo tênis grátis em um sorteio. O link pede seus dados pessoais. O perfil tem muitos seguidores, mas algo parece estranho. O que você faz agora?",
        ...
        options: [
          ...
          { id: "ignoreStory", text: "Ignorar o Story", next: "i_ignore1", points: 1, feedback: "Ignorar evita riscos imediatos, mas o golpe pode continuar." }
        ]
      },
      "i_ignore1": {
        text: "Você ignora o Story, mas recebe uma DM da mesma conta, dizendo que você foi 'selecionado' para o sorteio. A mensagem usa emojis de troféu 🏆 e parece oficial. O que você faz agora?",
        ...
        options: [
          ...
          { id: "checkDM", text: "Verificar a mensagem", next: "i_ignore2", points: 1, feedback: "Verificar mensagens é um bom passo, mas exige cuidado." },
      ...
      "i_ignore_report": {
        text: "Você denuncia o perfil, mas outro Story aparece de uma conta similar, 'SpectraShop', oferecendo um sorteio de placa de video, com o mesmo layout da pagina que você acabou de bloquear. Como você reage?",
        image: "/assets/images/instagram_new_story.jpg",
        options: [
          { id: "checkOfficial", text: "Visitar o site oficial da Nike", next: "i_ignore_support", points: 2, feedback: "Consultar o site oficial é uma forma segura de verificar promoções." },
          { id: "blockAccount", text: "Bloquear a nova conta", next: "i_ignore2", points: 1, feedback: "Bloquear impede novas mensagens, mas não resolve o golpe." },
          { id: "clickNewLink", text: "Clicar no novo link", next: "i_endIgnore2", points: 0, feedback: "Links suspeitos podem roubar seus dados. Evite clicar!" }
        ]
      },
      "i_ignore2": {
        text: "Ao verificar a DM, você nota que o link leva a um site com URL estranha (ex.: nike-promo.xyz). O Instagram alerta sobre uma tentativa de login de outro dispositivo. O que você faz agora?",
        image: "/assets/images/instagram_login_alert.jpg",
        options: [
          { id: "enable2FA", text: "Ativar autenticação de dois fatores", next: "i_ignore3", points: 2, feedback: "O 2FA adiciona uma camada extra de segurança à sua conta." },
          { id: "reportDM", text: "Denunciar a DM como spam", next: "i_ignore_support", points: 1, feedback: "Denunciar é útil, mas proteger sua conta é essencial." },
          { id: "ignoreAlerts", text: "Ignorar o alerta", next: "i_endIgnore2", points: 0, feedback: "Ignorar alertas de login pode comprometer sua conta." }
        ]
      },
      "i_ignore3": {
        ...
        options: [
          ...
          { id: "checkSettings", text: "Verificar configurações de segurança", next: "i_ignore4", points: 1, feedback: "Verificar configurações ajuda, mas ação imediata é necessária." },
      ...
      "i_ignore4": {
        text: "Você verifica as configurações e vê uma tentativa de login bloqueada. Um email 'do Instagram' pede para desativar o 2FA, alegando 'atualização de segurança'. O que você faz agora?",
        image: "/assets/images/instagram_email.jpg",
        options: [
          { id: "ignoreEmail", text: "Ignorar o email", next: "i_endBetterIgnore", points: 2, feedback: "Ignorar emails suspeitos é seguro, já que o Instagram nunca pede isso." },
          { id: "contactSupport", text: "Contatar o suporte do Instagram", next: "i_ignore_support", points: 1, feedback: "O suporte pode confirmar o golpe, mas sua conta já está segura." },
          { id: "disable2FA", text: "Desativar o 2FA", next: "i_endIgnore2", points: 0, feedback: "Desativar o 2FA deixa sua conta vulnerável." }
        ]
      },
      "i_ignore_support": {
        text: "Você encontra um artigo da Forbes dizendo que 70% dos sorteios no Instagram são golpes. Sua conta está segura! Dica: limite quem pode enviar DMs e verifique sempre o selo de verificação em perfis.",
        image: "/assets/images/medium_end.jpg",
        options: []
      },
      "i_endIgnore": {
        text: "Ignorar as mensagens permitiu que os golpistas continuassem enviando links falsos aos seus seguidores, usando seu perfil. Sempre denuncie contas suspeitas! Recupere sua conta em https://help.instagram.com/.",
        image: "/assets/images/bad_end.jpg",
        options: []
      },
      "i_endIgnore2": {
        text: "Clicar no link ou ignorar alertas comprometeu sua conta. Os golpistas postaram Stories falsos em seu nome. Verifique atividades suspeitas! Contate o suporte em https://help.instagram.com/.",
        image: "/assets/images/bad_end.jpg",
        options: []
      },
      "i_endBetterIgnore": {
      ...
      "i_endModerateIgnore": {
        text: "Bloquear a conta ajudou a evitar o golpe, mas sem 2FA, sua conta permanece vulnerável. Ative a autenticação de dois fatores e revise suas configurações de privacidade.",
        image: "/assets/images/medium_end.jpg",
        options: []
      },
      "i_click1": {
        ...
        options: [
          ...
          { id: "checkSettings", text: "Verificar configurações de segurança", next: "i_click2", points: 1, feedback: "Verificar configurações é um bom passo, mas ação imediata é necessária." }
        ]
      },
      "i_click2": {
        ...
        image: "/assets/images/instagram_login_alert.jpg",
        options: [
          { id: "enable2FA", text: "Ativar 2FA e mudar senha", next: "i_endVerifySafe", points: 2, feedback: "Ativar 2FA e mudar a senha protege sua conta imediatamente." },
          { id: "blockAccount", text: "Bloquear a conta", next: "i_click3", points: 1, feedback: "Bloquear impede novas mensagens, mas sua conta precisa de proteção." },
      ...
      "i_verify1": {
        text: "Você verifica o perfil e nota que ele não tem selo de verificação e usa fotos genéricas de produtos. Os comentários parecem automatizados. O que você faz agora?",
        ...
        options: [
          ...
          { id: "contactSupport", text: "Contatar o suporte do Instagram", next: "i_verify4", points: 2, feedback: "O suporte pode confirmar o golpe, mas ação imediata é necessária." }
        ]
      },
      "i_verify2": {
      ...
      "i_verify3": {
        text: "Você pesquisa o site visto no story 'M & M' e além das buscas do famoso doce, você não encontra mais nada sobre. O que você faz agora?",
        image: "/assets/images/instagram_search.jpg",
        options: [
          { id: "enable2FA", text: "Ativar 2FA e mudar senha", next: "i_endVerifySafe", points: 2, feedback: "Ativar 2FA e mudar a senha protege sua conta imediatamente." },
          { id: "reportDM", text: "Denunciar a DM", next: "i_ignore_support", points: 1, feedback: "Denunciar é útil, mas proteger sua conta é essencial." },
          { id: "ignoreDM", text: "Ignorar a mensagem", next: "i_endModerateIgnore", points: 1, feedback: "Ignorar evita riscos imediatos, mas não resolve o golpe." }
        ]
      },
      "i_verify4": {
        text: "O suporte do Instagram confirma que o perfil é falso e o remove. Como proteger sua conta agora?",
        image: "/assets/images/instagram_settings.jpg",
        options: [
          { id: "enable2FA", text: "Ativar 2FA e mudar senha", next: "i_endVerifySafe", points: 2, feedback: "Ativar 2FA e mudar a senha é a melhor proteção." },
          { id: "monitor", text: "Verificar sessões ativas da conta", next: "i_endModerateIgnore", points: 1, feedback: "Verificar sessões ajuda, mas é preciso mais proteção." },
          { id: "ignore", text: "Ignorar e continuar normalmente", next: "i_endIgnore", points: 0, feedback: "Ignorar deixa sua conta vulnerável a novos golpes." }
        ]
      },
      "i_endVerifySafe": {
        text: "Ativar 2FA e mudar a senha protegeu sua conta! Dica: 80% dos golpes no Instagram usam perfis falsos. Continue verificando o selo de verificação e limite quem pode enviar DMs.",
        image: "/assets/images/good_end.jpg",
        options: []
      }
    };
    ...
    const tiktokStoryParts = {
      "start": {
        text: "Você recebe uma DM no TikTok de um perfil viral, 'TrendMaster', convidando você para um 'desafio' que promete 10 mil seguidores. Eles pedem um vídeo enviado por um link. O perfil tem muitos likes, mas parece suspeito. O que você faz agora?",
        ...
        options: [
          ...
          { id: "ignoreMessage", text: "Ignorar a mensagem", next: "t_ignore1", points: 1, feedback: "Ignorar evita riscos imediatos, mas o golpe pode continuar." }
        ]
      },
      "t_ignore1": {
        text: "Você ignora a DM, mas o perfil posta um vídeo marcando você, pedindo participação no desafio com emojis de fogo 🔥. Os comentários parecem entusiasmados, mas genéricos. O que você faz agora?",
        ...
        options: [
          ...
          { id: "ignoreVideo", text: "Ignorar o vídeo", next: "t_endIgnore", points: 0, feedback: "Ignorar pode permitir que o golpe continue." }
        ]
      },
      "t_ignore_report": {
        text: "Você denuncia o vídeo, mas outra DM chega de um perfil chamado 'ViralNow', insistindo no desafio com um novo link. O perfil não parece confiável. Como você reage?",
      ...
      "t_ignore2": {
        ...
        options: [
          ...
          { id: "checkComments", text: "Continuar investigando comentários", next: "t_ignore_support", points: 1, feedback: "Investigar ajuda, mas proteger sua conta é essencial." },
      ...
      "t_ignore3": {
        text: "Você muda a senha, mas outro vídeo marcando você aparece, pedindo dados pessoais via link para 'completar o desafio'. O que você faz agora?",
        ...
        options: [
          ...
          { id: "reportVideo", text: "Denunciar o novo vídeo", next: "t_verify2", points: 1, feedback: "Denunciar é útil, mas sua conta precisa de proteção." },
          { id: "ignoreVideo", text: "Ignorar o vídeo", next: "t_end_verify_moderate", points: 1, feedback: "Ignorar evita riscos, mas não resolve o golpe." }
        ]
      },
      "t_ignore4": {
        ...
        options: [
          ...
          { id: "contactSupport", text: "Contatar o suporte do TikTok", next: "t_ignore_support", points: 1, feedback: "O suporte pode confirmar o golpe, mas sua conta já está segura." },
      ...
      "t_click2": {
        ...
        options: [
          ...
          { id: "checkSettings", text: "Verificar configurações de segurança", next: "t_click3", points: 1, feedback: "Verificar configurações ajuda, mas ação imediata é necessária." }
        ]
      },
      "t_click3": {
        ...
        options: [
          ...
          { id: "monitor", text: "Verificar sessões ativas da conta", next: "t_end_verify_moderate", points: 1, feedback: "Verificar sessões ajuda, mas é preciso mais proteção." },
      ...
      "t_verify3": {
        ...
        options: [
          { id: "enable2FA", text: "Ativar 2FA e mudar senha", next: "t_endVerifyRefresh", points: 2, feedback: "Ativar 2FA e mudar a senha protege sua conta imediatamente." },
          { id: "reportVideo", text: "Denunciar o vídeo", next: "t_ignore_support", points: 1, feedback: "Denunciar é útil, mas sua conta precisa de proteção." },
