...
"ignore_report": {
  ...
  options: [
    ...
    const instagramStoryParts = {
      "start": {
        text: "Você vê um Story no Instagram de um perfil chamado 'M & M' anunciando um sorteio de um Kit de Skin Care de luxo. O Story contém um link que leva a um formulário para participar do sorteio, mas algo na postagem como o texto genérico, a falta de detalhes claros. O que você faz agora?",
      ...
      "i_ignore1": {
        text: "Você decide ignorar o Story, mas recebe uma DM da mesma conta, afirmando que você foi selecionado para o sorteio, apesar do entusiasmo e da promessa, a falta de detalhes, a urgência e a ausência de um selo de verificação no perfil confirmam a tentativa de golpe. O que você faz agora?",
        ...
        options: [
          ...
          { id: "checkDM", text: "Denunciar a DM como spam", next: "i_ignore_support", points: 1, feedback: "Verificar mensagens é um bom passo, mas exige cuidado." },
      ...
      "i_ignore_report": {
        ...
        options: [
          { id: "checkOfficial", text: "Olhar configurações de segurança", next: "i_ignoreSettings", points: 2, feedback: "Consultar o site oficial é uma forma segura de verificar promoções." },
          { id: "blockAccount", text: "Bloquear e denunciar a nova conta", next: "i_click3", points: 1, feedback: "Bloquear impede novas mensagens, mas não resolve o golpe." },
          { id: "clickNewLink", text: "Visitar o site oficial da marca", next: "i_website", points: 0, feedback: "Links suspeitos podem roubar seus dados. Evite clicar!" }
        ]
      },
      "i_ignore3": {
        ...
        options: [
          ...
          { id: "checkSettings", text: "Verificar configurações de segurança", next: "i_ignoreSettings", points: 1, feedback: "Verificar configurações ajuda, mas ação imediata é necessária." }
        ]
      },
      "i_ignoreSettings": {
        ...
        options: [
          { id: "contactSupport", text: "Alterar apenas a senha", next: "i_ignore_password", points: 1, feedback: "Alterar a senha é um bom passo, mas ativar a autenticação de dois fatores (2FA) oferece proteção extra contra futuras tentativas." },
          { id: "ignoreEmail", text: "Alterar senha e ativar 2FA", next: "i_endVerifyRefresh", points: 5, feedback: "Alterar a senha e ativar o 2FA são medidas eficazes para proteger sua conta contra acessos não autorizados." },
          { id: "disable2FA", text: "Não alterar nada", next: "i_endModerateIgnore", points: 0, feedback: "Não tomar nenhuma ação pode deixar sua conta exposta a novas tentativas de invasão." }
        ]
      },
      "i_website": {
        ...
        options: [
          ...
          { id: "reportDM", text: "Denunciar a mensagem DM", next: "i_ignore_support", points: 1, feedback: "Denunciar é útil, mas proteger sua conta é essencial." },
          { id: "ignoreDM", text: "Ignorar todos os alertas", next: "i_endModerateIgnore", points: 0, feedback: "Ignorar evita riscos imediatos, mas não resolve o golpe." }
        ]
      },
      "i_ignore_password": {
      ...
      "i_verify1": {
        ...
        options: [
          ...
          { id: "contactSupport", text: "Perguntar para melhor amiga", next: "i_verify4", points: 2, feedback: "O suporte pode confirmar o golpe, mas ação imediata é necessária." }
        ]
      },
      "i_verify2": {
      ...
      "i_verify3": {
        text: "Você pesquisa o site visto no story e além das buscas do famoso doce, você não encontra mais nada sobre. voce volta ao instagram e O que você faz agora?",
      ...
      "i_verify4": {
        text: "Você decide conversar com sua melhor amiga sobre o perfil. Durante um bate-papo, você menciona o sorteio anunciado no Story. Ela responde que achou tentador e começou a seguir a página só por causa dele, mas não sabe nada sobre a marca e nunca participou de outros sorteios deles. O que você faz agora?",
        ...
        options: [
          ...
          { id: "ignore", text: "Investigar o link do sorteio", next: "i_endInvestigateLink", points: 1, feedback: "Verificar links com cuidado e usar um navegador seguro é a melhor proteção." }
        ]
      },
      "i_endVerifyRefresh": {
      ...
      "i_endInvestigateLink": {
        text: "Ao investigar o link do sorteio, você descobriu que ele levava a um site falso que pedia dados pessoais. Sua cautela evitou um golpe, mas o perfil continuou ativo. Sempre verifique links com atenção! Saiba mais sobre segurança em https://help.instagram.com/.",
        image: "/assets/images/medium_end.jpg",
        options: []
      },
      "i_endReportAlert": {
        text: "Denunciar o perfil e alertar sua amiga impediu que ela caísse no golpe, mas outros seguidores ainda podem ser enganados. Continue vigilante e reporte atividades suspeitas! Veja como se proteger em https://help.instagram.com/.",
        image: "/assets/images/good_end.jpg",
        options: []
      },
      "i_endInformation": {
